...
mod tests {
    ...
    #[test]
    fn cycle_handoff_template_is_novel_studio_oriented() {
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("Novel Studio Cycle Handoff Briefing"));
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("Book identity"));
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("Current chapter state"));
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("Open promises"));
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("Memory state"));
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("materials/"));
        assert!(CYCLE_HANDOFF_TEMPLATE.contains("reference-only"));
        assert!(!CYCLE_HANDOFF_TEMPLATE.contains("codebase"));
        assert!(!CYCLE_HANDOFF_TEMPLATE.contains("issue #"));
        assert!(!CYCLE_HANDOFF_TEMPLATE.contains("macOS sandbox"));
    }
