...
<title>Writer Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by Writer · https://github.com/luo-cccc/Writer
</div>
</body>
</html>"#,
    )
...
mod tests {
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("https://github.com/luo-cccc/Writer"));
    }
}
