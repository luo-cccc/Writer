...
/// Auto-select a model based on Novel Studio task complexity.
///
/// Short conversational/status messages use Flash. Long manuscript work,
/// continuity diagnosis, planning, revision, memory maintenance, export
/// preparation, and multi-asset analysis use Pro.
...
const COMPLEX_KEYWORDS: &[&str] = &[
    // Novel Studio slash/CLI workflows and English task words.
    "/plan",
    "/brief",
    "/empower",
    "/write",
...
character arcs, timelines, foreshadowing, exports, multi-asset tasks, ambiguous creative decisions, or tool-heavy work. \
Use thinking off only for trivial no-tool answers, high for ordinary reasoning, and max for \
agentic, multi-file, manuscript-wide, continuity-critical, memory/canon, RLM/sub-agent, tool-heavy, or uncertain work.";
...
mod tests {
    ...
    #[test]
    fn auto_model_heuristic_simplified_chinese_novel_keywords_route_to_pro() {
        for msg in [
            "\u{751f}\u{6210}\u{7b2c}\u{4e00}\u{7ae0}\u{7b80}\u{62a5}", // 生成第一章简报
            "\u{5199}\u{4f5c}\u{7b2c}\u{5341}\u{4e8c}\u{7ae0}",         // 写作第十二章
            "\u{5ba1}\u{8ba1}\u{4eba}\u{7269}\u{5f27}\u{7ebf}",         // 审计人物弧线
            "\u{68c0}\u{67e5}\u{8fde}\u{7eed}\u{6027}",                 // 检查连续性
            "\u{56de}\u{6536}\u{4f0f}\u{7b14}",                         // 回收伏笔
            "\u{66f4}\u{65b0}\u{8bb0}\u{5fc6}\u{56fe}",                 // 更新记忆图
            "\u{5206}\u{6790}\u{77e5}\u{8bc6}\u{8fb9}\u{754c}",         // 分析知识边界
        ] {
            assert_eq!(
    ...
    #[test]
    fn auto_model_heuristic_traditional_chinese_novel_keywords_route_to_pro() {
        for msg in [
            "\u{7522}\u{751f}\u{7b2c}\u{4e00}\u{7ae0}\u{7c21}\u{5831}", // 產生第一章簡報
            "\u{5beb}\u{4f5c}\u{7b2c}\u{5341}\u{4e8c}\u{7ae0}",         // 寫作第十二章
            "\u{5be9}\u{8a08}\u{4eba}\u{7269}\u{5f27}\u{7dda}",         // 審計人物弧線
            "\u{6aa2}\u{67e5}\u{9023}\u{7e8c}\u{6027}",                 // 檢查連續性
            "\u{56de}\u{6536}\u{4f0f}\u{7b46}",                         // 回收伏筆
            "\u{66f4}\u{65b0}\u{8a18}\u{61b6}\u{5716}",                 // 更新記憶圖
            "\u{5206}\u{6790}\u{77e5}\u{8b58}\u{908a}\u{754c}",         // 分析知識邊界
        ] {
            assert_eq!(
                auto_model_heuristic(msg, "auto"),
                "deepseek-v4-pro",
    ...
    #[test]
    fn auto_model_heuristic_novel_slash_commands_route_to_pro() {
        for msg in [
            "/brief 12",
            "/write 12",
            "/audit 12",
    ...
    fn auto_route_system_prompt_is_novel_studio_oriented() {
        ...
        assert!(!AUTO_MODEL_ROUTER_SYSTEM_PROMPT.contains("coding"));
        assert!(!AUTO_MODEL_ROUTER_SYSTEM_PROMPT.contains("debugging"));
        assert!(!AUTO_MODEL_ROUTER_SYSTEM_PROMPT.contains("release"));
    }
