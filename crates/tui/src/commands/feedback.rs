...
const SECURITY_POLICY_URL: &str = "https://github.com/luo-cccc/Writer/security/policy";
...
impl FeedbackKind {
    ...
    fn issue_url_base(self) -> &'static str {
        match self {
            Self::Bug => "https://github.com/luo-cccc/Writer/issues/new?template=bug_report.md",
            Self::Feature => {
                "https://github.com/luo-cccc/Writer/issues/new?template=feature_request.md"
            }
...
mod tests {
    ...
    fn feedback_urls_use_template_only() {
        ...
        assert_eq!(
            bug,
            "https://github.com/luo-cccc/Writer/issues/new?template=bug_report.md"
        );
        assert_eq!(
            feature,
            "https://github.com/luo-cccc/Writer/issues/new?template=feature_request.md"
