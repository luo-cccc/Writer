...
pub enum MessageId {
    ...
    CmdPlanDescription,
    CmdBriefDescription,
    CmdEmpowerDescription,
    CmdWriteDescription,
    CmdAuditDescription,
    CmdReviseDescription,
    CmdRememberDescription,
    CmdChapterDiffDescription,
    CmdChapterUndoDescription,
    CmdJobsDescription,
    CmdLinksDescription,
    CmdLoadDescription,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::CmdBriefDescription,
    MessageId::CmdEmpowerDescription,
    MessageId::CmdWriteDescription,
    MessageId::CmdAuditDescription,
    MessageId::CmdReviseDescription,
    MessageId::CmdRememberDescription,
...
fn english(id: MessageId) -> &'static str {
    match id {
        MessageId::ComposerPlaceholder => "Ask for a chapter, memory check, or use /.",
        ...
        MessageId::CmdClearDescription => "Clear the current workspace conversation",
        MessageId::CmdCompactDescription => {
        ...
        MessageId::CmdExportDescription => "Export the novel from finalized chapters",
        MessageId::CmdFeedbackDescription => "Generate a GitHub feedback URL",
        MessageId::CmdHelpDescription => "Show help information",
        MessageId::CmdHomeDescription => "Show the novel workspace dashboard",
        MessageId::CmdHooksDescription => "List configured lifecycle hooks (read-only)",
        MessageId::CmdAgentDescription => {
            "Open a persistent writing sub-agent: /agent [0-3] <task>"
        }
        MessageId::CmdGoalDescription => "Set a session goal with optional token budget",
        MessageId::CmdInitDescription => "Create a local long-form novel workspace",
        MessageId::CmdPlanDescription => "Generate or refresh the book plan",
        MessageId::CmdBriefDescription => "Generate a focused chapter brief",
        MessageId::CmdEmpowerDescription => "Build optional craft notes for a chapter",
        MessageId::CmdWriteDescription => "Draft a chapter from book memory and outline",
        MessageId::CmdAuditDescription => "Diagnose continuity and memory risks in a chapter",
        MessageId::CmdReviseDescription => "Revise a chapter using memory diagnosis",
        MessageId::CmdRememberDescription => "Extract chapter memory into reviewable candidates",
        MessageId::CmdChapterDiffDescription => "Compare chapter draft, final, and saved versions",
        MessageId::CmdChapterUndoDescription => "Restore the latest saved chapter version",
        ...
        MessageId::CmdMemoryDescription => "Inspect or manage long-form writing memory",
        MessageId::CmdModeDescription => {
        ...
        MessageId::CmdSkillDescription => {
            "Activate a writing skill, or install/update/uninstall/trust a craft pack"
        }
        MessageId::CmdSkillsDescription => {
            "List Novel Studio writing skills (filter by `/skills <prefix>`; --remote browses craft packs)"
        }
        MessageId::CmdStashDescription => {
        ...
        MessageId::HomeDashboardTitle => "DeepSeek Novel Studio",
        MessageId::HomeModel => "Model:",
        MessageId::HomeMode => "Mode:",
        MessageId::HomeWorkspace => "Workspace:",
        MessageId::HomeHistory => "Turns:",
        MessageId::HomeTokens => "Context:",
        ...
        MessageId::HomeQuickLinks => {
            "/init       - Create book.toml, bible, cards, chapters, memory"
        }
        MessageId::HomeQuickSkills => "/memory     - Inspect long-form memory",
        MessageId::HomeQuickConfig => "/note       - Add or inspect workspace notes",
        MessageId::HomeQuickSettings => "/settings    - Show persistent settings",
        MessageId::HomeQuickModel => "/model       - Switch or view model",
        MessageId::HomeQuickSubagents => "/subagents  - List writing sub-agent status",
        MessageId::HomeQuickTaskList => "/task list  - Show background writing tasks",
        MessageId::HomeQuickHelp => "/help       - Show workspace help",
        MessageId::HomeModeTips => "Mode Tips",
        MessageId::HomeAgentModeTip => "Agent mode - writes book assets with approval",
        MessageId::HomeAgentModeReviewTip => {
            "  Use Plan mode for outline, continuity, and revision design"
        }
        MessageId::HomeAgentModeYoloTip => "  Use /mode yolo only for trusted batch writing",
        MessageId::HomeYoloModeTip => "YOLO mode - autonomous book-asset edits",
        MessageId::HomeYoloModeCaution => "  Preserve user prose and avoid broad overwrites",
        MessageId::HomePlanModeTip => "Plan mode - read bible/cards/chapters before changing files",
        MessageId::HomePlanModeChecklistTip => {
            "  Use it for arcs, memory diagnosis, and revision plans"
        }
        ...
        MessageId::OnboardTipsLine1 => {
            "Start with /init, then ask for a premise, outline, chapter, revision, or memory check."
        }
        MessageId::OnboardTipsLine2 => {
            "The bottom composer is multi-line: Enter sends, Alt+Enter or Ctrl+J adds a new line."
        }
        MessageId::OnboardTipsLine3 => {
            "Switch modes only when the job changes: Plan for story design, Agent for confirmed writes, YOLO for trusted batch work."
        }
        MessageId::OnboardTipsLine4 => {
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdExportDescription => "確定章から小説をエクスポート",
        MessageId::CmdFeedbackDescription => "GitHub フィードバック URL を生成",
        MessageId::CmdHelpDescription => "ヘルプを表示",
        MessageId::CmdHomeDescription => "小説ワークスペースのダッシュボードを表示",
        MessageId::CmdHooksDescription => {
            "設定済みのライフサイクルフックを一覧表示（読み取り専用）"
        }
        MessageId::CmdAgentDescription => "永続的な執筆サブエージェントを開く: /agent [0-3] <task>",
        MessageId::CmdGoalDescription => "トークンバジェット付きのセッション目標を設定",
        MessageId::CmdInitDescription => "ローカルの長編小説ワークスペースを作成",
        MessageId::CmdPlanDescription => "作品全体の計画を生成・更新",
        MessageId::CmdBriefDescription => "章ごとの執筆ブリーフを生成",
        MessageId::CmdEmpowerDescription => "章の任意クラフトメモを作成",
        MessageId::CmdWriteDescription => "記憶とアウトラインから章を下書き",
        MessageId::CmdAuditDescription => "章の連続性と記憶リスクを診断",
        MessageId::CmdReviseDescription => "記憶診断を使って章を改稿",
        MessageId::CmdRememberDescription => "章の記憶を確認用候補として抽出",
        MessageId::CmdChapterDiffDescription => "章の下書き、確定稿、保存版を比較",
        MessageId::CmdChapterUndoDescription => "直近に保存した章バージョンを復元",
        ...
        MessageId::CmdMemoryDescription => "長編執筆メモリを確認・管理",
        MessageId::CmdModeDescription => {
        ...
        MessageId::HomeHistory => "ターン：",
        MessageId::HomeTokens => "コンテキスト：",
        MessageId::HomeQueued => "キュー：",
        MessageId::HomeSubagents => "サブエージェント：",
        MessageId::HomeSkill => "スキル：",
        MessageId::HomeQuickActions => "クイックアクション",
        MessageId::HomeQuickLinks => "/init       - book.toml、聖典、カード、章、メモリを作成",
        MessageId::HomeQuickSkills => "/memory     - 長編メモリを確認",
        MessageId::HomeQuickConfig => "/note       - ワークスペースノートを追加・確認",
        MessageId::HomeQuickSettings => "/settings    - 永続化された設定を表示",
        MessageId::HomeQuickModel => "/model       - モデルを切り替え・確認",
        MessageId::HomeQuickSubagents => "/subagents  - 執筆サブエージェント状態を一覧",
        MessageId::HomeQuickTaskList => "/task list  - バックグラウンド執筆タスクを表示",
        MessageId::HomeQuickHelp => "/help       - ワークスペースヘルプを表示",
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        MessageId::ComposerPlaceholder => "写章节、查记忆，或使用 /。",
        ...
        MessageId::CmdClearDescription => "清除当前小说工作区对话",
        MessageId::CmdCompactDescription => {
        ...
        MessageId::CmdExportDescription => "从终稿章节导出整本小说",
        MessageId::CmdFeedbackDescription => "生成 GitHub 反馈链接",
        MessageId::CmdHelpDescription => "显示帮助信息",
        MessageId::CmdHomeDescription => "显示小说工作台主面板",
        MessageId::CmdHooksDescription => "列出已配置的生命周期钩子（只读）",
        MessageId::CmdAgentDescription => "打开持久写作子代理：/agent [0-3] <task>",
        MessageId::CmdGoalDescription => "设置带有可选令牌预算的会话目标",
        MessageId::CmdInitDescription => "创建本地长篇小说工作区",
        MessageId::CmdPlanDescription => "生成或刷新整本书规划",
        MessageId::CmdBriefDescription => "生成单章写作简报",
        MessageId::CmdEmpowerDescription => "为章节生成可选写法札记",
        MessageId::CmdWriteDescription => "依据书稿记忆和大纲起草章节",
        MessageId::CmdAuditDescription => "诊断章节连续性和记忆风险",
        MessageId::CmdReviseDescription => "依据记忆诊断修订章节",
        MessageId::CmdRememberDescription => "提取章节记忆为待确认候选项",
        MessageId::CmdChapterDiffDescription => "对比章节草稿、终稿和已保存版本",
        MessageId::CmdChapterUndoDescription => "恢复最近保存的章节版本",
        ...
        MessageId::CmdMemoryDescription => "查看或管理长篇写作记忆",
        ...
        MessageId::CmdSkillDescription => "激活写作技能，或安装/更新/卸载/信任技法包",
        MessageId::CmdSkillsDescription => {
            "列出 Novel Studio 写作技能（用 `/skills <prefix>` 过滤，--remote 浏览技法包）"
        }
        ...
        MessageId::HomeHistory => "轮次：",
        MessageId::HomeTokens => "上下文：",
        MessageId::HomeQueued => "队列：",
        MessageId::HomeSubagents => "子代理：",
        MessageId::HomeSkill => "技能：",
        MessageId::HomeQuickActions => "快捷操作",
        MessageId::HomeQuickLinks => "/init       - 创建 book.toml、圣经、卡片、章节和记忆",
        MessageId::HomeQuickSkills => "/memory     - 查看长篇记忆",
        MessageId::HomeQuickConfig => "/note       - 添加或查看工作区笔记",
        MessageId::HomeQuickSettings => "/settings    - 显示持久化设置",
        MessageId::HomeQuickModel => "/model       - 切换或查看模型",
        MessageId::HomeQuickSubagents => "/subagents  - 列出写作子代理状态",
        MessageId::HomeQuickTaskList => "/task list  - 显示后台写作任务",
        MessageId::HomeQuickHelp => "/help       - 显示工作台帮助",
        MessageId::HomeModeTips => "模式提示",
        MessageId::HomeAgentModeTip => "Agent 模式 - 经确认后写入小说资产",
        MessageId::HomeAgentModeReviewTip => "  Plan 模式适合大纲、连续性和修订方案",
        MessageId::HomeAgentModeYoloTip => "  只在可信目录中用 /mode yolo 批量写作",
        MessageId::HomeYoloModeTip => "YOLO 模式 - 自动编辑书籍资产",
        MessageId::HomeYoloModeCaution => "  保留用户正文，避免大范围覆盖",
        MessageId::HomePlanModeTip => "Plan 模式 - 改文件前先读圣经、卡片和章节",
        MessageId::HomePlanModeChecklistTip => "  用于角色弧、记忆诊断和修订计划",
        // Onboarding — language picker.
        ...
        MessageId::OnboardTipsLine1 => {
            "先用 /init 建书籍工程，再让它做设定、大纲、章节、修订或记忆诊断。"
        }
        MessageId::OnboardTipsLine2 => "底部输入框支持多行：Enter 发送，Alt+Enter 或 Ctrl+J 换行。",
        MessageId::OnboardTipsLine3 => {
            "按任务切换模式：Plan 做故事设计，Agent 做确认后的写入，YOLO 只用于可信批量写作。"
        }
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdExportDescription => "Exportar o romance a partir dos capítulos finais",
        ...
        MessageId::CmdHomeDescription => "Exibir o painel do workspace de romance",
        MessageId::CmdHooksDescription => {
            "Listar hooks de ciclo de vida configurados (somente leitura)"
        }
        MessageId::CmdAgentDescription => {
            "Abrir um sub-agente persistente de escrita: /agent [0-3] <task>"
        }
        MessageId::CmdGoalDescription => {
            "Definir uma meta de sessão com orçamento de tokens opcional"
        }
        MessageId::CmdInitDescription => "Criar um workspace local de romance longo",
        MessageId::CmdPlanDescription => "Gerar ou atualizar o plano do livro",
        MessageId::CmdBriefDescription => "Gerar um briefing focado de capítulo",
        MessageId::CmdEmpowerDescription => "Criar notas opcionais de escrita para um capítulo",
        MessageId::CmdWriteDescription => "Rascunhar um capítulo a partir da memória e do esboço",
        MessageId::CmdAuditDescription => {
            "Diagnosticar riscos de continuidade e memória no capítulo"
        }
        MessageId::CmdReviseDescription => "Revisar um capítulo usando diagnóstico de memória",
        MessageId::CmdRememberDescription => {
            "Extrair memória do capítulo como candidatas revisáveis"
        }
        MessageId::CmdChapterDiffDescription => {
            "Comparar rascunho, final e versões salvas do capítulo"
        }
        MessageId::CmdChapterUndoDescription => "Restaurar a versão salva mais recente do capítulo",
        ...
        MessageId::CmdMemoryDescription => "Inspecionar ou gerenciar a memória de escrita longa",
        MessageId::CmdModeDescription => {
        ...
        MessageId::HomeWorkspace => "Workspace:",
        MessageId::HomeHistory => "Turnos:",
        MessageId::HomeTokens => "Contexto:",
        MessageId::HomeQueued => "Enfileirado:",
        MessageId::HomeSubagents => "Sub-agentes:",
        MessageId::HomeSkill => "Skill:",
        MessageId::HomeQuickActions => "Ações Rápidas",
        MessageId::HomeQuickLinks => {
            "/init       - Criar book.toml, biblia, cards, capitulos e memoria"
        }
        MessageId::HomeQuickSkills => "/memory     - Inspecionar memoria longa",
        MessageId::HomeQuickConfig => "/note       - Adicionar ou ver notas do workspace",
        ...
        MessageId::HomeQuickSubagents => "/subagents  - Listar status dos sub-agentes de escrita",
        MessageId::HomeQuickTaskList => "/task list  - Exibir tarefas de escrita em segundo plano",
        MessageId::HomeQuickHelp => "/help       - Exibir ajuda do workspace",
