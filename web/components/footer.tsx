...
const EN_COLS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Support Writer", href: "https://github.com/luo-cccc/Writer" },
    ],
  },
  {
    title: "Resources",
...
const ZH_COLS = [
  {
    ...
    items: [
      ...
      { label: "版本发布", href: "https://github.com/luo-cccc/Writer/releases" },
    ],
  },
  {
    title: "社区",
    items: [
      { label: "议题", href: "https://github.com/luo-cccc/Writer/issues" },
      { label: "合并请求", href: "https://github.com/luo-cccc/Writer/pulls" },
      { label: "讨论区", href: "https://github.com/luo-cccc/Writer/discussions" },
      { label: "参与贡献", href: "/zh/contribute" },
      { label: "支持 Writer", href: "https://github.com/luo-cccc/Writer" },
    ],
  },
  {
    title: "资源",
    items: [
      ...
      { label: "行为准则", href: "https://github.com/luo-cccc/Writer/blob/main/CODE_OF_CONDUCT.md" },
      { label: "安全策略", href: "https://github.com/luo-cccc/Writer/blob/main/SECURITY.md" },
      { label: "MIT 许可证", href: "https://github.com/luo-cccc/Writer/blob/main/LICENSE" },
    ],
  },
];
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-12 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2 md:col-span-2 space-y-4">
          <div className="flex items-center gap-3">
            <Seal char="深" size="md" />
            <div>
              <div className="font-display text-xl font-semibold">Writer</div>
              <div className="font-cjk text-[0.7rem] text-ink-mute tracking-widest">
                {isZh ? "深度求索 · 小说工作台" : "DeepSeek · fiction studio"}
              </div>
            </div>
          </div>
          <p className="text-sm text-ink-soft max-w-md leading-relaxed">
            {isZh
              ? "基于 DeepSeek V4 的本地优先长篇小说创作工作台。MIT 许可证。欢迎提交 Pull Request。"
          ...
          {isZh && (
            <div className="pt-2 border-t border-paper-line/20">
              ...
              <div className="flex flex-wrap gap-3 text-xs">
                {GITEE_ENABLED && <a href="https://gitee.com/luo-cccc/Writer" className="text-indigo hover:underline" target="_blank" rel="noopener">Gitee 镜像</a>}
      ...
      <div className="hairline-t">
        <div className="mx-auto max-w-[1400px] px-6 py-4 flex flex-col gap-2 text-[0.78rem] text-ink-soft">
          <div>
            ...
            <a href="https://github.com/luo-cccc/Writer/security/advisories/new" className="font-mono text-ink hover:text-indigo">GitHub private advisory</a>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 font-mono text-[0.7rem] text-ink-mute uppercase tracking-widest">
            <span>© {new Date().getFullYear()} · Writer · luo-cccc</span>
