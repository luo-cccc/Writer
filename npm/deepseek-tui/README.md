...
[docs/INSTALL.md](https://github.com/luo-cccc/Writer/blob/main/docs/INSTALL.md)
...
- Set `DEEPSEEK_TUI_GITHUB_REPO` or `DEEPSEEK_GITHUB_REPO` to override the source repo (defaults to `luo-cccc/Writer`).
